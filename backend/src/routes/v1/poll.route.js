...
import { optionalVerifyToken } from "../../middlwares/optionalVerifyToken.js";
 ...
 *         description: Internal server error
 */
pollRouter.get("/data/:pollId", getPollDataController);
...
// Public voting endpoint: allows anyone with the link to vote once,
// while server-side logic limits repeat/abusive voting.
pollRouter.post("/public/vote", validator(voteSchema), optionalVerifyToken, createVoteController);
